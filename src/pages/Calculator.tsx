...
export function Calculator() {
  ...
  const [currentPeriod, setCurrentPeriod] = useState<{ type: 'month' | 'week'; number: number } | undefined>();
                ...
                <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                  <TaxBreakdown
                    ...
                    colorScheme={{
                      ...
                      rowHoverBg: "hover:bg-govuk-grey/50 dark:hover:bg-govuk-blue/30",
                  ...
                  <TaxBreakdown
                    ...
                    colorScheme={{
                      ...
                      rowHoverBg: "hover:bg-govuk-grey/50 dark:hover:bg-purple-900/30",
