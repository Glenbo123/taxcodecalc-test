 ...
 */
export const convertToHourly = (yearlyAmount: number, hoursPerWeek: number = 40): number => {
    if (!yearlyAmount || isNaN(yearlyAmount) || !hoursPerWeek || hoursPerWeek <= 0) return 0;
 ...
 */
export const validateSalaryInput = (amount: number, maxAmount: number = 10000000): boolean => {
