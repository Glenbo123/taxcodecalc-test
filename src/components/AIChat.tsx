  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      type: 'assistant',
      content: "Hello! I'm your HMRC Tax Calculator assistant. How can I help you today?",
      timestamp: new Date()
    }
  ]);
            ...
            <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-govuk-blue/10 flex items-center justify-center">
                  <svg className="w-6 h-6 text-govuk-blue" viewBox="0 0 24 24" fill="none" stroke="currentColor" aria-hidden="true">
                    <circle cx="12" cy="12" r="10" strokeWidth="2"/>
                    <path d="M12 16v-4M12 8h.01" strokeWidth="2" strokeLinecap="round"/>
                  </svg>
                </div>
                <div>
                  <h2 id="chat-dialog-title" className="text-lg font-semibold text-gray-900 dark:text-white">AI Assistant</h2>
                  <p className="text-sm text-gray-500 dark:text-gray-400">HMRC Tax Calculator Help</p>
                </div>
              </div>
              <button
                onClick={onClose}
            ...
            >
              ...
              {isTyping && (
                <div className="flex justify-start">
                  <div className="bg-gray-100 dark:bg-gray-700 rounded-lg p-3" aria-label="Assistant is typing">
...
function getAIResponse(input: string): string {
  ...
  if (normalizedInput.includes('salary') || normalizedInput.includes('income')) {
